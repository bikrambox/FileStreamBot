...
class Var(object):
    ...
    # BIN_CHANNEL = int("5113796278", "453214768" , "-1002058639288")
    BIN_CHANNEL = -1002058639288
    # BIN_CHANNEL = int(
    #     environ.get("BIN_CHANNEL", None)
    # )  # you NEED to use a CHANNEL when you're using MULTI_CLIENT
    PORT = int(environ.get("PORTOLIGO", 9001))
    ...
    SESSION_NAME = str(environ.get('SESSION_NAME', 'FiredrakeBot'))
